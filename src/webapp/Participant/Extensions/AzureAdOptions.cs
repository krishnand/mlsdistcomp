namespace Microsoft.AspNetCore.Authentication
{
    ...
    public class AzureAdOptions
    {
        ...
        /// <summary>
        /// Client Secret (Application password) added in the 
        /// Azure portal in the Keys section for the application
        /// </summary>
        ...
        /// <summary>
        /// Central Registry Tenant Id, as obtained from the Azure portal:
        /// (Select 'Endpoints' from the 'App registrations' blade and use the GUID in any of the URLs)
        /// </summary>
        public string CentralRegistryTenantId { get; set; }
        ...
        /// </summary>
        public string CentralRegistryAuthority
        {
            get
            {
                return $"{Instance}{CentralRegistryTenantId}";
            }
        }
        ...
        /// <summary>
        /// Client Id (Application ID) of the MRSDistComp Web API application, 
        /// obtained from the Azure portal for that application.
        /// </summary>
        ...
        /// obtained from the Azure portal for that application.
        /// </summary>
        public string CentralRegistryResourceAppId { get; set; }

        /// <summary>
        /// Base URL of the MRSDistComp Web APIs
        /// </summary>
        ...
        /// Base URL of the MRSDistComp Web APIs
        /// </summary>
        public string CentralRegistryBaseAddress { get; set; }
